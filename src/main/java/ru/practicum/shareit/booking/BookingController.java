...
public class BookingController {
    ...
    public BookingResponse create(@Positive @RequestHeader(USER_HEADER) Long userId,
    ...
    public BookingResponse read(@Positive @RequestHeader(USER_HEADER) Long userId,
    ...
    @GetMapping
    public Collection<BookingResponse> readUserBookings(@Positive @RequestHeader(USER_HEADER) Long userId,
    ...
    @GetMapping("/owner")
    public Collection<BookingResponse> readUserAsOwnerBookings(@Positive @RequestHeader(USER_HEADER) Long userId,
                                                               @Valid @Pattern(regexp = STATE_REGEX)
                                                               @RequestParam(required = false,
                                                                       defaultValue = "ALL") String state) {
    ...
    public BookingResponse updateStatus(@Positive @RequestHeader(USER_HEADER) Long userId,
                                        @Positive @PathVariable Long bookingId,
